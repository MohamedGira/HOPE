...
public class RecyclerViewAdapter3 extends RecyclerView.Adapter<RecyclerViewAdapter3.MyView> {
    ...
    public class MyView extends RecyclerView.ViewHolder {
        ...
        public MyView(View view) {
            ...
            img = (ImageView) view.findViewById(R.id.textview3);
    ...
    public RecyclerViewAdapter3(ArrayList<Drawable> horizontalList) {
    ...
    public MyView onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.horizontal_item3, parent, false);
